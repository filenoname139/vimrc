...
" Focus terminal
nnoremap <silent> <C-F7> <C-\><C-n><C-W><Left>
tnoremap <silent> <C-F7> <C-\><C-n><C-W><Left>
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Git
nnoremap <silent> <F10> :FloatermNew! --position=bottomright --height=0.95 --width=0.7 --title='GitLog' git lg<CR>
